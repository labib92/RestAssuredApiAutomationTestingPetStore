...
public class PetStoreTests {
    ...
    public void testGetStoreInventory(){
        ...
        Response response = PetStoreEndPoints.getInventory();
    ...
    public void testPlaceOrder(){
        ...
        Response response = PetStoreEndPoints.placeOrder(petStorePayload);
    ...
    public void testFindPlacedOrderById(){
        ...
        Response response = PetStoreEndPoints.findOrderById(petStorePayload.getId());
        response.then().log().all();
    ...
    public void testDeleteOrder(){
        ...
        Response response = PetStoreEndPoints.deleteOrder(petStorePayload.getId());
        response.then().log().all();
