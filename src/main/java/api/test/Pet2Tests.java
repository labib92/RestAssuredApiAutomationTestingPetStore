...
public class Pet2Tests {
    ...
    public void testAddNewPet(){
        ...
        Response response = PetEndPoints2.addNewPet(petPayLoad);
    ...
    public void testUpdatePetWithFormData(){
        ...
        Response response = PetEndPoints2
    ...
    public void testUploadImage(){
        ...
        Response response = PetEndPoints2.uploadAnImage(petPayLoad.getId() , petPayLoad.getName(), image);
        response.then().log().all();
    ...
    public void  testGetPetById(){
        ...
        Response response = PetEndPoints2.getPetById(petPayLoad.getId());
        response.then().log().all();
    ...
    public void testGetPetByStatus(){
        ...
        Response response = PetEndPoints2.getPetByStatus(petPayLoad.getStatus());
        response.then().log().all();
    ...
    public void deletePet(){
        ...
        Response response = PetEndPoints2.deletePet(petPayLoad.getId());
        response.then().log().all();
